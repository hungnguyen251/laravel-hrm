                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="type">
                                        <option></option>
                                        <option {{ old('type') == '1' ? 'selected' : ''}} value="1">Toàn thời gian</option>
                                        <option {{ old('type') == '2' ? 'selected' : ''}} value="2">Bán thời gian</option>
                                        <option {{ old('type') == '3' ? 'selected' : ''}} value="3">Thực tập sinh</option>
                                        <option {{ old('type') == '0' ? 'selected' : ''}} value="0">Thử việc</option>
                                    </select>
                                    @if ($errors->has('type'))
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="gender">
                                        <option {{ old('gender') == '0' ? 'selected' : ''}} value="0">Nam</option>
                                        <option {{ old('gender') == '1' ? 'selected' : ''}} value="1">Nữ</option>
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="marriage_status">
                                        <option {{ old('marriage_status') == '0' ? 'selected' : ''}} value="0">Độc thân</option>
                                        <option {{ old('marriage_status') == '1' ? 'selected' : ''}} value="1">Đã kết hôn</option>
                                    </select>
