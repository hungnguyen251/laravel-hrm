    ...
    <div class="content-wrapper">
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Danh sách vị trí chức danh</h1>
                </div>
                </div>
            </div>
        </section>
        ...
        <section class="content-header">
            <div class="card">
                    ...
                    <div class="col-md-6 offset-md-2">
                        <form action="{{ route('filter.search') }}" id="search">
                            <div class="input-group mt-3">
                                ...
                                <input name="route_name" type="hidden" value="positions.index">
                ...
                <div class="card-header">
                    <button type="submit" class="btn btn-info float-right"><a href="{{ route('positions.create') }}" style="width: 100px;color:white"><i class="fas fa-plus"></i></a></button>
                </div>
                ...
                <div class="card-body">
                    <table class="table table-bordered" style="text-align: center;">
                        <thead>
                            <tr>
                                <th>ID</th>
                                <th><a class="text-dark" href="{{ route('filter.sort', ['orderBy' => Request::input('orderBy') !== null ? Request::input('orderBy') : '', 'sortBy' => 'name', 'route' => 'positions.index' ]) }}">
                                    Tên chức danh
                                ...
                                <th><a class="text-dark" href="{{ route('filter.sort', ['orderBy' => Request::input('orderBy') !== null ? Request::input('orderBy') : '', 'sortBy' => 'created_at', 'route' => 'positions.index' ]) }}">
                                    Ngày tạo 
                                ...
                                <td>
                                    <div class="btn-group">
                                        ...
                                        <div class="dropdown-menu">
                                            <form action="{{ route('positions.edit', ['id' => $item->id]) }}" method="POST">
                                                @csrf
                                                <button class="dropdown-item" type="submit">Sửa</button>
                                            </form>
                                            <form action="{{ route('positions.destroy', ['id' => $item->id]) }}" method="POST">
                                                @csrf
                                                @method('DELETE')
