        ...
        <section class="content-header">
            <div class="card">
                    ...
                    <div class="col-md-6 offset-md-2">
                        <form action="{{ route('filter.search') }}" id="search">
                            <div class="input-group mt-3">
                                ...
                                <input name="route_name" type="hidden" value="departments.index">
                ...
                <div class="card-header">
                    <button type="submit" class="btn btn-info float-right"><a href="{{ route('departments.create') }}" style="width: 100px;color:white"><i class="fas fa-plus"></i></a></button>
                </div>
                ...
                <div class="card-body">
                    <table class="table table-bordered" style="text-align: center;">
                        <thead>
                            <tr>
                                <th>ID</th>
                                <th><a class="text-dark" href="{{ route('filter.sort', ['orderBy' => Request::input('orderBy') !== null ? Request::input('orderBy') : '', 'sortBy' => 'name', 'route' => 'departments.index' ]) }}">
                                    Tên phòng ban
                                ...
                                <th><a class="text-dark" href="{{ route('filter.sort', ['orderBy' => Request::input('orderBy') !== null ? Request::input('orderBy') : '', 'sortBy' => 'created_at', 'route' => 'departments.index' ]) }}">
                                    Ngày tạo
